      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">Your Premium Streaming Experience</p>
          </div>
          ...
          <div className="footer-social">
            ...
            <div className="social-links">
              ...
              <button type="button" className="social-link" aria-label="YouTube">
                <svg viewBox="0 0 24 24">
        ...
        <div className="footer-bottom">
          <div className="footer-info">
            <p>&copy; 2024 Stream Vault. All rights reserved.</p>
            <p>Premium streaming experience for entertainment enthusiasts.</p>
          </div>
